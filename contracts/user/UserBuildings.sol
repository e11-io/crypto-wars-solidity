...
contract UserBuildings is NoOwner, Versioned {
   ...
   */
  event AddUserBuildings(address indexed user, uint[] ids, uint[] indexes);
   ...
   */
  event UpgradeBuilding(address indexed user, uint id, uint index);
   ...
   */
  event AddInitialBuildings(address indexed user, uint[] ids);
   ...
   */
  event RemoveUserBuildings(address indexed user, uint[] ids, uint[] indexes);
   ...
   * Its added to the UserBuildings array to give it an index, and set as Active False.
   * @param _user the address of the user to initialize the buildings
   * @param _id the id of the building to be initialize
